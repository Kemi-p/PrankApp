...
export const MenuItems: MenuItem[] = [
  ...
  { id: 'disappointment',     label: 'Room Temp (like a disappointment)',  advertised: 'R5', realPrice: 3,   category: 'temperature' },
 
  { id: 'emotional-1',        label: '😶 Emotionally unavailable',         advertised: 'R5', realPrice: 89,  category: 'chaos'       },
  { id: 'emotional-2',        label: '😬 Barely holding it together',      advertised: 'R5', realPrice: 47,  category: 'chaos'       },
  { id: 'emotional-3',        label: '🌈 Suspiciously positive',           advertised: 'R5', realPrice: 112, category: 'chaos'       },
  { id: 'garfield-1',         label: 'Today (I never miss it)',            advertised: 'R5', realPrice: 5,   category: 'chaos'       },
  { id: 'garfield-2',         label: 'Never. What is Garfield?',           advertised: 'R5', realPrice: 200, category: 'chaos'       },
  { id: 'garfield-3',         label: 'Only on Mondays, for courage',       advertised: 'R5', realPrice: 77,  category: 'chaos'       },
  { id: 'earth-1',            label: 'Yes, every single day',              advertised: 'R5', realPrice: 150, category: 'chaos'       },
  { id: 'earth-2',            label: 'No, I have a life',                  advertised: 'R5', realPrice: 25,  category: 'chaos'       },
  { id: 'earth-3',            label: 'CircleThingie 1 is better',          advertised: 'R5', realPrice: 999, category: 'chaos'       },
];
...
export const OrderedCat: MenuCategory[] = [
  'coffee', 'milk', 'sugar', 'extras', 'size', 'temperature', 'chaos',
];
